...
echo -e "         Auther : ${green}RMBL VPN ${NC}${YELLOW}(${NC} ${green}RMBL VPN ${NC}${YELLOW})${NC}"
echo -e "       © Recode By RMBL VPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/VPN-ZERO/vip/main/"
